from .agent_library import get_agent_profile, library
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(agent_config, str):
            ...
            agent_config = get_agent_profile(agent_name=name, work_dir=work_dir)
...
class MultiAssistantBase(ABC):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.work_dir = work_dir if work_dir is not None else code_execution_config.get("work_dir", "coding")
